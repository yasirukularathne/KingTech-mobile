...
export function Nav({ children }: { children: ReactNode }) {
  return (
    <nav className="sticky top-2 z-50 bg-primary/70 text-primary-foreground flex items-center justify-between px-6 py-3 rounded-3xl shadow-lg mt-4 mx-auto max-w-4xl backdrop-blur-lg border border-white/30">
